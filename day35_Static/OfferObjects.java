...
public class OfferObjects {
    public static void main(String[] args) {
        ...
        /*
        2.  Create a class called MyOffers
        ...
        // Accept.removeIf(p-> p.salary < 100000 || p.isFullTime == false || !p.location.equals(myLocation)); // we remove the offer if it's less than 100K or
