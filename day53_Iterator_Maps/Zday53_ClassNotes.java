...
public class Zday53_ClassNotes {
    /*
    06/25/2020
Topic: Iterable
	   Map Intro
...
Iterable(I): Root interface
		...
		Iterator(I):
			...
			next(): if  hasNext() is true, it accesses to the object and retrives it

			remove(): removes the current element of iteartion



Monday:
	morning: Maps
	afternoon: StringBuilder & buffer, Garbage collector, enum, finalize
