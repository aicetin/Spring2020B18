...
public class C09_NestedLoops2_2DArrays {
    public static void main(String[] args) {
        int [][] numbers = {{9,8,7},{6},{5,4,3,2,1,0}};
                //             0     1       2
        /*
        numbers[0]===> {9,8,7}; numbers [0][i] i needs to be repeated 3 times
        numbers[1] ===> {6};    numbers [1][i] i needs to be repeated 1 times
        numbers [2]===> {5,4,3,2,1}; numbers [1][i] i needs to be repeated 6 times
