 ...
 */
public class A05_Java_Python_WUT {
    public static void main(String[] args) {
        String sentence = "I like java and python and also javascript";

        sentence =  sentence.toLowerCase();

        int countJava = 0 ;  // 2
        int countPython =0 ; // 1
        String[] words = sentence.split(" ");   //[I, like, java, and, python, and, also, javascript]  8
