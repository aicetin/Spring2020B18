...
public class PrimitiveCastings {
    ...
    public static void main(String[] args) {
        ...
        int a1 = 100;
        long b1 = (long) a1 ; // manually doing the impilicity casting
        ...
        short Snum = (byte)Inum; // casting has to be same or smaller than datatype
        ...
        System.out.println(intNum); // it gives different number because 9999999999 is out int' range
